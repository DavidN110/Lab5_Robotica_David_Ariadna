...
class PincherGUI:
    ...
    def setup_tab1(self):
        """Configura la pestaña 1: Control por Sliders en Tiempo Real (Ángulos) Ariadna & David"""
    ...
    def setup_tab2(self):
        """Configura la pestaña 2: Control por Valores (Ángulos) Ariadna & David"""
    ...
    def setup_tab3(self):
        """Configura la pestaña 3: Visualización en RViz Ariadna & David"""
...
• Feedback visual de los movimientos
    ...
    def setup_tab4(self):
        "Configura 5 Poses de prueba y valores articulars reales Ariadna & David"
        ...
        buttons_frame.pack(side='left', fill='y', padx=(30, 0))  # separación con la otra columna

        button_test1 = tk.Button(buttons_frame, text="Pose1", width=12, command=self.home_all)
        button_test1.pack(side='top', fill='x', padx=10)
        ...
        button_test2.pack(side='top', fill='x', padx=5)
        ...
        button_test3.pack(side='top', fill='x', padx=5)
        ...
        button_test4.pack(side='top', fill='x', padx=5)
        ...
        button_test5.pack(side='top', fill='x', padx=5)
    ...
    def setup_tab5(self):
        """
        Cinemática Directa Ariadna & David
        """
        ...
        main_frame.pack(fill='x', padx=30, pady=60)
        ...
        for i,coord in enumerate(["X", "Y", "Z"]):
            ...
            lbl = tk.Label(row, text=f"{coord} [mm]:",
                        font=("Arial", 20, "bold"), width=10, anchor='w')
            lbl.pack(side='left')

            value_lbl = tk.Label(row, text="0.0",
                                font=("Arial", 15), width=12, anchor='w')
